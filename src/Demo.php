...
use changyuan\umengpush\android\AndroidBroadcast;
use changyuan\umengpush\android\AndroidCustomizedcast;
use changyuan\umengpush\android\AndroidFilecast;
use changyuan\umengpush\android\AndroidGroupcast;
use changyuan\umengpush\android\AndroidUnicast;
use changyuan\umengpush\ios\IOSBroadcast;
use changyuan\umengpush\ios\IOSCustomizedcast;
use changyuan\umengpush\ios\IOSFilecast;
use changyuan\umengpush\ios\IOSGroupcast;
use changyuan\umengpush\ios\IOSUnicast;
use Exception;
...
class Demo
{
    ...
    public function sendAndroidUnicast()
    {
        try {
            ...
            $unicast->setPredefinedKeyValue("device_toke
